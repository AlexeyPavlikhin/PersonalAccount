...
/*
    ...
    onChangeClientEmails(){
        this.getClientEmails();
        this.$emit('update_client_data');
    },

    onChangeClientJob(in_clientID, in_clientJob){
        //alert('Event in Parent'+" "+in_clientID+" "+in_clientJob);
        this.detail_client_job = in_clientJob;
        this.$emit('update_client_data');
    },
    onChangeClientComment(in_clientID, in_clientComment){
        //alert('Event in Parent'+" "+in_clientID+" "+in_clientComment);
        this.detail_client_comment = in_clientComment;
        this.$emit('update_client_data');
    },
*/    
                ...
                <tr>
                    ...
                    <td>
                        <div v-for="detail_client_telegram in detail_client_telegrams">
                            <a href="https://t.me/ detail_client_telegram">@{{detail_client_telegram.telegram}}</a>
                        </div>
                    </td>
