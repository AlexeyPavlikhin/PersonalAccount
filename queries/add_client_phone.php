...
if(isset($_SESSION['current_user_id'])){
    ...
    try {
        $sql = "INSERT INTO clients_phone (client_id, phone) VALUES ('".$data['client_id']."', '".$data['phone']."')";
